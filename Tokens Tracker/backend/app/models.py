...
class WeeklyNewsItem(Base):
    __tablename__ = "weekly_news_items"
    ...
    impact: Mapped[str] = mapped_column(String(20), nullable=False, default="Watch")
    reading_time: Mapped[str] = mapped_column(String(30), nullable=False, default="3 min read")
    ...
    takeaways_json: Mapped[str] = mapped_column(Text, nullable=False)
    fetched_at: Mapped[datetime] = mapped_column(DateTime, nullable=False, default=datetime.utcnow)
    is_published: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False, index=True)

    __table_args__ = (
        Index("idx_weekly_category_date", "category", "published_at"),
    )
